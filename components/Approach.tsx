  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center absolute top-[50%] left-[50%] group-hover/canvas-card:-translate-y-4 group-hover/canvas-card:opacity-0 transition duration-200 w-full translate-x-[-50%] translate-y-[-50%] mx-auto flex items-center justify-center">
          {icon}
        </div>
